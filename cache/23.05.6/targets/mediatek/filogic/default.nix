...
{
  baseUrl = "https://downloads.immortalwrt.org/releases/23.05.6/targets/mediatek/filogic/";
  sha256sums = {
    hash = "sha256-PoAqHFTL8nZKEOhEtWBwG7OOOu61ZENLt91tDGT7P+8=";
    name = "mediatek_filogic-sha256sums";
    url = "https://downloads.immortalwrt.org/releases/23.05.6/targets/mediatek/filogic/sha256sums";
  };
  imagebuilder = {
    sha256 = "0d1973ea6e77f897afab3f5de2468c493cafb523bda3540e3ed80a839c59b19c";
    filename = "immortalwrt-imagebuilder-23.05.6-mediatek-filogic.Linux-x86_64.tar.xz";
  };
  profiles.sourceInfo = {
    hash = "sha256-TNVXyOCLTvbnevostxbXd9DAqPCNrCdAn019pkG5Nr8=";
    name = "mediatek_filogic-profiles.json";
    url = "https://downloads.immortalwrt.org/releases/23.05.6/targets/mediatek/filogic/profiles.json";
  };
  profiles.extract = {
    ...
    kmods_target = "5.15.189-1-dab81cfed92fb4881f7b4fec9f787850";
    profiles = {
      abt_asr3000 = {
        device_packages = [
  ...
  corePackages = {
    baseUrl = "https://downloads.immortalwrt.org/releases/23.05.6/targets/mediatek/filogic/packages/";
    sourceInfo = {
      hash = "sha256-stXXgg66OlED0tMzqCbBzMIxRNJKLuO2GfUAPEXodOo=";
      name = "mediatek_filogic-Packages";
      url = "https://downloads.immortalwrt.org/releases/23.05.6/targets/mediatek/filogic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
