...
{
  baseUrl = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/";
  sha256sums = {
    hash = "sha256-Pd3DXlK9FPWb4NBlrQ/mIK+XsIp1Mzv1MYhK2x+t7DA=";
    name = "starfive_generic-sha256sums";
    url = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/sha256sums";
  };
  imagebuilder = {
  ...
  profiles.sourceInfo = {
    ...
    url = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/profiles.json";
  };
  profiles.extract = {
  ...
  kmods."6.6.122-1-5c9cbc5d46a40c4c54266ccf8d455650" = {
    baseUrl = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/kmods/6.6.122-1-5c9cbc5d46a40c4c54266ccf8d455650/";
    sourceInfo = {
      hash = "sha256-d0i6Gq/+eTkMOtqUpKotgsTZU2B0lqVlfHy6ySoJaAg=";
      name = "kmods-starfive_generic-Packages";
      url = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/kmods/6.6.122-1-5c9cbc5d46a40c4c54266ccf8d455650/Packages";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/packages/";
    sourceInfo = {
      hash = "sha256-rPfmTmOYnfpeIQHUEZpLmsvGjTL7A4F/cH+rQsWXFoI=";
      name = "starfive_generic-Packages";
      url = "https://downloads.immortalwrt.org/releases/24.10.5/targets/starfive/generic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
