...
{
  baseUrl = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/";
  sha256sums = {
    hash = "sha256-o/bygl8sjOevX541uBxiuJP8KE26/XifV3XF3+ljFEk=";
    name = "mediatek_filogic-sha256sums";
    url = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/sha256sums";
  };
  imagebuilder = {
    sha256 = "e6af4f8c5db66e52c4bd5e2b629f8a617d61c6ebc94dc8c52754fa143cb4ac9a";
    filename = "immortalwrt-imagebuilder-25.12.2-mediatek-filogic.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-AN+R1bV/eg9AeefMM22gMZQGHLCrGNiByqy3XoxhVWU=";
    name = "mediatek_filogic-profiles.json";
    url = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "aarch64_cortex-a53";
    linux_kernel = {
      release = "1";
      vermagic = "b5b7729ffbba3ecdd83f339de8fadfb8";
      version = "6.12.103";
    };
    default_packages = [
      "apk-openssl"
    ...
    kmods_target = "6.12.103-1-b5b7729ffbba3ecdd83f339de8fadfb8";
    profiles = {
      abt_asr3000 = {
        device_packages = [
          "kmod-mt7915e"
  ...
  kmods."6.12.103-1-b5b7729ffbba3ecdd83f339de8fadfb8" = {
    baseUrl = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/kmods/6.12.103-1-b5b7729ffbba3ecdd83f339de8fadfb8/";
    sourceInfo = {
      hash = "sha256-EkfrzBEcUS5GuFWT3oQQ+iw8uVPTVmAUsKXdUrsI36I=";
      name = "kmods-mediatek_filogic-packages.adb";
      url = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/kmods/6.12.103-1-b5b7729ffbba3ecdd83f339de8fadfb8/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/packages/";
    sourceInfo = {
      hash = "sha256-eWrIyx77/pBO+rUm82qOnY/6yZoPO9/AcZhJq124/aM=";
      name = "mediatek_filogic-packages.adb";
      url = "https://downloads.immortalwrt.org/releases/25.12.2/targets/mediatek/filogic/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
