...
{
  baseUrl = "https://downloads.immortalwrt.org/releases/21.02.7/targets/mpc85xx/p1010/";
  sha256sums = {
    hash = "sha256-AT8Q90v9DLkdg7pA4yFpjsTibc10lGC15omdOuY7f5U=";
    name = "mpc85xx_p1010-sha256sums";
    url = "https://downloads.immortalwrt.org/releases/21.02.7/targets/mpc85xx/p1010/sha256sums";
  };
  imagebuilder = {
  ...
  profiles.sourceInfo = {
    ...
    url = "https://downloads.immortalwrt.org/releases/21.02.7/targets/mpc85xx/p1010/profiles.json";
  };
  profiles.extract = {
  ...
  corePackages = {
    baseUrl = "https://downloads.immortalwrt.org/releases/21.02.7/targets/mpc85xx/p1010/packages/";
    sourceInfo = {
      hash = "sha256-rlPWPn1kZerZAlzP/6egMoKT6o42f2uKzpUDGOBDG3o=";
      name = "mpc85xx_p1010-Packages";
      url = "https://downloads.immortalwrt.org/releases/21.02.7/targets/mpc85xx/p1010/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
