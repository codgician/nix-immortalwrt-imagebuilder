...
{
  baseUrl = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/";
  sha256sums = {
    hash = "sha256-U6gOkMoCQJNiSOQnGoFl1iSdYON8GCTXJhfpFqGIxrY=";
    name = "mediatek_filogic-sha256sums";
    url = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/sha256sums";
  };
  imagebuilder = {
    sha256 = "0a5f73a4b3c3a54e04712c49ce6cbac571f7102ed53471744205e3e3ec9e5023";
    filename = "immortalwrt-imagebuilder-25.12.0-mediatek-filogic.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-hR5Y7qGg+jAN15I2bnK1fZOhWhLdilS+WMRt65ZUElw=";
    name = "mediatek_filogic-profiles.json";
    url = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "aarch64_cortex-a53";
    linux_kernel = {
      release = "1";
      vermagic = "24374d30cf46b9bf43d4901f3df3aac6";
      version = "6.12.87";
    };
    default_packages = [
      "apk-openssl"
    ...
    kmods_target = "6.12.87-1-24374d30cf46b9bf43d4901f3df3aac6";
    profiles = {
      abt_asr3000 = {
        device_packages = [
          "kmod-mt7915e"
  ...
  kmods."6.12.87-1-24374d30cf46b9bf43d4901f3df3aac6" = {
    baseUrl = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/kmods/6.12.87-1-24374d30cf46b9bf43d4901f3df3aac6/";
    sourceInfo = {
      hash = "sha256-tMDx3kKJmS/eAGNb7cywOeIXevCRc3FtnqkNugfGE5w=";
      name = "kmods-mediatek_filogic-packages.adb";
      url = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/kmods/6.12.87-1-24374d30cf46b9bf43d4901f3df3aac6/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/packages/";
    sourceInfo = {
      hash = "sha256-VC9NIIHTdb9lmq9czagOud2V/2TNWVnPC/9EobhRf38=";
      name = "mediatek_filogic-packages.adb";
      url = "https://downloads.immortalwrt.org/releases/25.12.0/targets/mediatek/filogic/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
