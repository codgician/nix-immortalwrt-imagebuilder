# 24.10.4 package feeds for arm_fa526
{
  ...
  feeds."routing" = {
    baseUrl = "https://downloads.immortalwrt.org/releases/24.10.4/packages/arm_fa526/routing/";
    sourceInfo = {
      hash = "sha256-NCSt6U26rs4wbars8BKQeyGrebGh6d5iUFwr3nOXZsE=";
      name = "arm_fa526-routing-Packages";
      url = "https://downloads.immortalwrt.org/releases/24.10.4/packages/arm_fa526/routing/Packages";
    };
    packages =
      let
  ...
  feeds."telephony" = {
    baseUrl = "https://downloads.immortalwrt.org/releases/24.10.4/packages/arm_fa526/telephony/";
    sourceInfo = {
      hash = "sha256-6i6DbqndCbABCi68DoKSCDk219PIHAHOpoZOEMepkcg=";
      name = "arm_fa526-telephony-Packages";
      url = "https://downloads.immortalwrt.org/releases/24.10.4/packages/arm_fa526/telephony/Packages";
    };
    packages =
      let
